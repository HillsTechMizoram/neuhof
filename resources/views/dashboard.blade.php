                                ...
                                <div class="col-lg-4 col-md-4 order-1">
                                    <div class="row ">
                                        <div class="col-lg-6 col-md-12 col-6 mb-4 ">
                                            <div class="card">
                                                <div class="card-body">
                                                    <span class="fw-semibold d-block mb-1">Total No. of Contact</span>
                                                    <h3 class="card-title mb-2">{{ $contact }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <span>Total No. of Post</span>
                                                    <h3 class="card-title text-nowrap mb-1">{{ $posts }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ...
                                , made with ❤️ by
                                <a href="" target="_blank" class="footer-link fw-bolder">HillsTech Mizoram</a> &
                                <a href="https://techcafe.digital" target="_blank"
                                    class="footer-link fw-bolder">TechCafe</a>
