...
<body>
                ...
                <div class=" text-white" >
                    <p class="position-absolute start-50 translate-middle fs-2 text-center" >
                        <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                         ...
                         <label style="font-size: 77px;" class="mb-4">Mama Mia</label> <br> 
                        <label class="" style="font-size: 32px;">
                            Home/Major Production/Mama Mia
                        </label>
                    </p>
    ...
    <div class="container">
        ...
        <p class="text-center" style="font-weight: 700;font-size: 77px;;">MAMA MIA</p>
