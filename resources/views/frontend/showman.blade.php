...
<body>
                ...
                <div class=" text-white" >
                    <p class="position-absolute start-50 translate-middle fs-2 text-center" >
                        <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                         ...
                         <label style="font-size: 77px;" class="mb-4">The Greatest Showman</label> <br> 
                        <label class="" style="font-size: 32px;">
                            Home/Major Production/The Greatest Showman
                        </label>
                    </p>
    ...
    <div class="container">
        ...
        <p class="text-center" style="font-weight: 700;font-size: 77px;;">The Greatest Showman</p>
