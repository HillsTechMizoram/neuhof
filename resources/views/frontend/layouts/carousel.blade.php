...
<div class="container-fluid p-0 mb-5">
    <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="{{ asset('assets/img/function.jpg') }}" alt="">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                style="background: rgba(24, 29, 56, .7);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8 ms-3">
                            {{-- <h5 class="text-uppercase mb-3 animated slideInDown">Zirna Hmunpui --}}
                            </h5>
                            <h1 class="display-3 text-white animated slideInDown">Chibai! Kan lo lawm a che.
                            </h1>
                            <p class="fs-5 text-white mb-4 pb-2">I fate hlawhtlinna kawng an um zel theih nan
                                leh thiamna dik tak an neih theih nan lo luh tir ve rawh le.</p>
